...
import Profile from '../assets/bhanusir.png';
...
<p className="mt-6 text-lg leading-8 text-gray-600 sm:text-xl md:text-2xl lg:text-3xl">
  Hi, <b>I'm Y.Bhanu Prasad</b>, a passionate Software Developer dedicated to creating innovative and efficient software solutions.
</p>
{/* Resume Button */}
{/* <a
      href={Resume}
      ...
      className="mt-6 inline-flex items-center justify-center rounded-md bg-indigo-600 px-6 py-3 text-white font-semibold text-lg hover:bg-indigo-700 transition-all"
    >
      View My Resume
    </a> */}
    ...
    <div >
         ...
         <TypedIntro />
                    ...
                    <div className="lg:block lg:ml-20">
                        <img src={Profile} alt="" className="rounded-full" style={{ width:"300px", height:"250px"}} />
                    </div>
                </div>
                <div
                    aria-hidden="true"
